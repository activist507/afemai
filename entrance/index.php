<?php 
	...
	$intakeCode = $_SESSION['intakeCode'];
	$class = $_SESSION['class'];
	$subject = $conn->query("SELECT question_id,subject FROM questions WHERE question_type='Entrance' AND class = '$class'")->fetch_all(MYSQLI_ASSOC);
...
?>
            ...
            <div class="card-footer bg-body-tertiary py-2 text-center">
                <div class="row gy-3">
                    <div class="row my-3">
                        ...
                        <div class="col-lg-4 d-flex flex-start pt-3 justify-content-center">
                            <a href="#" class="btn btn-primary" data-question_id="<?= $subj['question_id']?>"
                                style="width: 200px;"><?= $subj['subject']?></a>
                        </div>
                        <?php endforeach;?>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $('.btn-primary').click(function(e) {
            e.preventDefault();
            var question_id = $(this).attr("data-question_id").trim();
