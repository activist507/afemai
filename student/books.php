<?php 
    $books = $conn->query("SELECT * FROM books WHERE class = '$Student_Class' ORDER BY subject ASC");
                    ...
                    <div class="col-sm-6 mb-2 mb-sm-0">
                        <div class="tom-select-custom">
                            <input type="text" class="form-control text-center text-uppercase fw-bold" id="topic"
                                disabled value="Class Books" style="background:rgba(214, 226, 214, 0.93);">
                        </div>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                <div class="text-center">
                                    <a href="#" class="btn btn-link p-0 viewVid" data-vid="<?= $book->id?>">
...
$(document).ready(function() {
    ...
    $('.viewVid').click(function() {
        var book_id = $(this).attr("data-vid");
        $.ajax({
