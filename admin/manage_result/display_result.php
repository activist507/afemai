...
<main id="main" class="main">
	...
	<div class="card mt-3">
            <div class="card-header py-0 d-flex flex-center bg-secondary justify-content-center">
                <h5 class="mb-0 text-white mt-2 text-uppercase text-center"><strong> Display Results</strong>
                </h5>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            ...
                            <table class="table small table-bordered">
                                <thead>
                                    <tr>
										...
										<th scope="col" nowrap="nowrap">Grade</th>
                                        <th scope="col" nowrap="nowrap">T_Score</th>
                                        <th scope="col" nowrap="nowrap">Sub_Failed</th>
                                    </tr>
                                </thead>
                                <tbody id="stdList">
                            ...
                            <!-- End Table with stripped rows new_plain_pass -->
							 <div class="row mb-2">
								<div class="col-4">
									<input type="text" name="outOf" id="outOf" class="form-control text-center w-100" value="0" data-bs-toggle="tooltip"
											data-bs-placement="top" title="Total Entries" disabled>
								</div>
								<div class="col-4">
									<input type="text" name="Pass" id="Pass" class="form-control text-center w-100" value="0"data-bs-toggle="tooltip"
											data-bs-placement="top" title="Pass" disabled>
								</div>
								<div class="col-4 ">
									<input type="text" name="Fail" id="Fail" class="form-control text-center w-100" value="0" data-bs-toggle="tooltip"
											data-bs-placement="top" title="Fail" disabled>
								</div>
							 </div>
...
$(document).ready(function() {
    ...
    function loadData3(page = 1, search = '') {
        ...
        $.ajax({
            url: '../admin/manage_result/display_result_db.php',
            type: 'POST',
