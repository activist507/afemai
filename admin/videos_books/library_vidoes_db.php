...
include('../../admin/config/db_connect.php');
    ...
    if(isset($_POST['type']) && $_POST['type'] == 'submitVideo'){
      ...
      if($auto_video_ID == ''){
        ...
        if(isset($_FILES['file'])){
            ...
            // $fornow = "library_videos/".$nam;
            $folder = "../../storege/library_videos/".$nam;
    ...
    if(isset($_POST['type']) && $_POST['type'] == 'getVideo'){
        ...
        $result['video_path'] = "../storege/library_videos/".$video->file_path;
    ...
    if(isset($_POST['type']) && $_POST['type'] == 'delete_vid'){
        ...
        $file = '../../storege/library_videos/'.$video->file_path;
        if(file_exists($file)){
            if(unlink($file)){
                clearstatcache();
