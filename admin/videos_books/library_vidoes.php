<?php 
    ...
    $video_play_backs = $conn->query("SELECT * FROM video_play_backs WHERE class='all' ORDER BY id DESC LIMIT 30");
                        ...
                        <div class="col-sm-2 mb-2 mb-sm-0">
                            <div class="tom-select-custom">
                                <input type="text" class="form-control text-center text-uppercase" disabled
                                    value="Library Videos" style="background:rgba(214, 226, 214, 0.93);">
                            </div>
                        </div>
