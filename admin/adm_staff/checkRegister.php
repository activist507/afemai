<?php 
$branchsql = $conn->query("SELECT Branch_Name FROM branches");
?>
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Check Register Staff</h1>
        <nav>
            <ol class="breadcrumb">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-5 col-sm-12">
                                <div class="tom-select-custom">
                                    <select name="branch" id="branch" class="form-control" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Class">
                                        <?php while($branch = $branchsql->fetch_object()){ ?>
...
$(document).ready(function() {
    ...
    $('#chk_reg_btn').click(function() {
        ...
        $.ajax({
            url: 'adm_staff/checkRegister_db.php',
            type: 'POST',
            dataType: 'json',
            cache: false,
            data: {
